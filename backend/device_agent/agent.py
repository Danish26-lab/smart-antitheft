...
# Use Vercel backend URL by default, but allow override via environment variable
# For local development, set API_BASE_URL environment variable to http://localhost:5000/api
...
class DeviceAgent:
    ...
    def create_default_config(self):
        ...
        config = {
            ...
            "report_interval": 3,  # 3 seconds for live location updates
            ...
            if device_registered:
                ...
                try:
                    ...
                    if verify_response.status_code == 200:
                        ...
                        logging.warning(f"[AUTO-REG] Device {self.device_id} not found on server, re-registering with agent-first method...")
    ...
    def report_status(self):
        ...
        try:
            ...
            if self.last_known_location:
                ...
                elif distance < 25:  # Device barely moved - use cached so map still follows when user moves

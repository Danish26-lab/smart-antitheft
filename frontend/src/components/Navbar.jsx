      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          <div className="relative hidden sm:block">
            <button className="text-slate-400 hover:text-white p-2 rounded-lg hover:bg-slate-700/50 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center space-x-2 text-slate-300 hover:text-white p-1 sm:p-2 rounded-lg hover:bg-slate-700/50 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors"
            ...
            >
              ...
              <span className="hidden sm:block text-sm md:text-base text-slate-200">{user?.name || 'User'}</span>
            </button>
